...
public class YApplicationContext {
    ...
    private Map<String, YBeanDefinition> definitionsMap = new HashMap<String, YBeanDefinition>();

    private Map<String, YBeanWrapper> factoryBeanInstanceCache = new HashMap<String, YBeanWrapper>();
    //二级缓存
    private Map<String, Object> factoryObjectInstanceCache = new HashMap<String, Object>();
